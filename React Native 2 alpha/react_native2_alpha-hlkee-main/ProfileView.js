  ...
  render() {
    return (
      ...
      >
        ...
        <View>
          <Text style={{ textAlignVertical: "center", fontWeight: "700" }}>
            Daily Calories: {this.state.goalDailyCalories + ""} kCals
          </Text>
        </View>
        <TextInput
          accessibilityLabel="Edit Daily Calories in"
          style={styles.input}
          underlineColorAndroid="transparent"
          placeholderTextColor="#d9bebd"
        ...
        <View>
          <Text style={{ textAlignVertical: "center", fontWeight: "700" }}>
            Daily Protein: {this.state.goalDailyProtein} grams
          </Text>
        </View>
        <TextInput
          accessibilityLabel="Daily Protein in grams"
          style={styles.input}
          underlineColorAndroid="transparent"
          // placeholder="52"
          placeholderTextColor="#d9bebd"
        ...
        <View>
          <Text style={{ textAlignVertical: "center", fontWeight: "700" }}>
            Daily Carbs: {this.state.goalDailyCarbohydrates} grams
          </Text>
        </View>
        <TextInput
          accessibilityLabel="Daily Carbohydrates in grams"
          style={styles.input}
          underlineColorAndroid="transparent"
          // placeholder="130"
          placeholderTextColor="#d9bebd"
        ...
        <View>
          <Text style={{ textAlignVertical: "center", fontWeight: "700" }}>
            Daily Fat: {this.state.goalDailyFat} grams
          </Text>
        </View>
        <TextInput
          accessibilityLabel="Daily Fats in grams"
          style={styles.input}
          underlineColorAndroid="transparent"
          // placeholder="35"
          placeholderTextColor="#d9bebd"
        ...
        <View>
          <Text style={{ textAlignVertical: "center", fontWeight: "700" }}>
            Daily Activity: {this.state.goalDailyActivity} minutes
          </Text>
        </View>
        <TextInput
          accessibilityLabel="Daily Activity in Minutes"
          style={styles.input}
          underlineColorAndroid="transparent"
          // placeholder="60"
          placeholderTextColor="#d9bebd"
        ...
        <View style={{ flexDirection: "row", flexWrap: "wrap" }}>
          <Button
            ...
            onPress={() => {
              ...
              this.props.handleGoalChange(this.state.goalDailyActivity);
            }}
          />
